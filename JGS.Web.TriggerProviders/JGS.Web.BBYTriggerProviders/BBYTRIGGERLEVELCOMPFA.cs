...
{
    public class BBYTRIGGERLEVELCOMPFA : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public BBYTRIGGERLEVELCOMPFA()
        {
            this.Name = "BBYTRIGGERLEVELCOMPFA";
        }
        ...
        public override XmlDocument Execute(System.Xml.XmlDocument xmlIn)
        {
            ...
            if (Trigger == "FAILUREANALYSIS")
            {
                ...
                Result = Functions.DbFetch(this.ConnectionString, "WEBAPP1", "JGSBBYLEVELCOMPONENT", "GETNIVEL", myParams);
                if (Result == "No")
                {
                    Msg = "Trigger Error: El componente " + PartNo + " no tiene valor en el campo Nivel,  llamar al Supervisor";
