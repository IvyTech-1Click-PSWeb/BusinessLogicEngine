...
{
    public class BBYTRIGGERPROCESSTYPE : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public BBYTRIGGERPROCESSTYPE()
        {
            this.Name = "BBYTRIGGERPROCESSTYPE";
        }
        ...
        public override XmlDocument Execute(System.Xml.XmlDocument xmlIn)
        {
            ...
            if (Trigger.ToUpper() == "TIMEOUT")
            {
                ...
                FFLineValue = Functions.DbFetch(this.ConnectionString, "WEBAPP1", "JGSRIMPROCESSTYPE", "GETFFPGA", myParams2); 
                if (RC.ToUpper() == "RC_RTV")
                {
                    if (FFLineValue == null)
                    {
                        Msg = "Error: unidad no puede ser enviada a RTV, seleccione otro Result Code";
                ...
                if (FFLineValue == "NPI")
                {
                    Msg = "Error: unidad catalogada como NPI, repórtela a su supervisor";
