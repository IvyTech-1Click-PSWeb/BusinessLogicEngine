...
namespace JGS.Web.TriggerProviders
{
    public class LenovoAME
    {
        ...
        public LenovoAME(string connectionString, int locationID, int clientID, string userName, string warranty, string cid, string repairable, string productClass, string productSubClass, ref string warrantyStatus,
                      ...
                      if (groupDisp.Equals("SCRAP-OW-ONLY", ignoreCase) || groupDisp.Equals("SCRAP-ALL", ignoreCase))
                       {
                        ...
                        this.remCode = "OWS";
                        this.condition = "TBE";
                        setLocation(xLenovoDictionary._locations["AME_SCRAP"]);
                       }
                       else
                       {
                        errorFound = true;
                     ...
                     else
                     {
                        if (repairable.Equals("YES", ignoreCase))
                        {
                            if (groupDisp.Equals("PROCESS-ALL", ignoreCase) || groupDisp.Equals("SCRAP-OW-ONLY", ignoreCase))
                            {
                                ...
                                setLocation(xLenovoDictionary._locations["AME_TO"]);
                            }
                            else
                            {
                                errorFound = true;
