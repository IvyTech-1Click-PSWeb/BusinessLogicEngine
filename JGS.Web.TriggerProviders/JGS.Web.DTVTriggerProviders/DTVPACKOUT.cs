...
{
    public class DTVPACKOUT : TriggerProviderBase
    {
        ...
        public override XmlDocument Execute(System.Xml.XmlDocument xmlIn)
        {
            ...
            myParams.Add(new OracleParameter("processName", OracleDbType.Varchar2, "DTVPACKOUT".ToString().Length, ParameterDirection.Input) { Value = "DTVPACKOUT" });
            ...
            if (workcenter.ToUpper().Equals("Pack Out".ToUpper()))
            {
                ...
                if (result.ToUpper().Equals("NPF") || result.ToUpper().Equals("REPAIRED") || result.ToUpper().Equals("TO_OBA") || result.ToUpper().Equals("COM_RPR"))
                {                    
                    ...
                    if (OBARequired.ToUpper().Contains("True".ToUpper()))
                    {
                        if (!result.ToUpper().Contains("TO_OBA"))
                        {
                ...
                DataSet dsUnitFAInfo = ODPNETHelper.ExecuteDataset(this.ConnectionString, CommandType.StoredProcedure, "WEBADAPTERS1.QueryAdapter.GetUnitFAInfo", myParams.ToArray());                
                //DbFetchds(this.ConnectionString, "WEBADAPTERS1", "QueryAdapter", "GetUnitFAInfo", myParams);
                ...
                myParams.Add(new OracleParameter("p_cursor", OracleDbType.RefCursor, ParameterDirection.Output));
                DataSet dsFACompReq = ODPNETHelper.ExecuteDataset(this.ConnectionString, CommandType.StoredProcedure, Schema_name + "." + Package_name + "." + "GetFAInfReq", myParams.ToArray()); 
                    //DbFetchds(this.ConnectionString, Schema_name, Package_name, "GetFAInfReq", myParams);
                ...
                if (opt.ToUpper().Equals("WRP") && (result.ToUpper().Equals("NPF") || result.ToUpper().Equals("REPAIRED")
                    || result.ToUpper().Equals("COM_RPR")))
                {
                    string Com_Rpr = "NO";
                    ...
                    myParams = new List<OracleParameter>();
                    myParams.Add(new OracleParameter("geo", OracleDbType.Varchar2, geo.ToString().Length,
                        ParameterDirection.Input) { Value = geo });
                    myParams.Add(new OracleParameter("client", OracleDbType.Varchar2, client.ToString().Length,
                        ParameterDirection.Input) { Value = client });
                    myParams.Add(new OracleParameter("contract", OracleDbType.Varchar2, contract.ToString().Length,
                        ParameterDirection.Input) { Value = contract });
                    myParams.Add(new OracleParameter("opt", OracleDbType.Varchar2, opt.ToString().Length,
                        ParameterDirection.Input) { Value = opt });
                    myParams.Add(new OracleParameter("workcenter", OracleDbType.Varchar2, workcenter.ToString().Length,
                        ParameterDirection.Input) { Value = workcenter });
                    myParams.Add(new OracleParameter("result", OracleDbType.Varchar2, result.ToString().Length,
                        ParameterDirection.Input) { Value = result });
                    myParams.Add(new OracleParameter("itemId", OracleDbType.Int32, itemId.ToString().Length,
                        ParameterDirection.Input) { Value = itemId });
                    myParams.Add(new OracleParameter("LanguageInd", OracleDbType.Int32, LanguageInd.ToString().Length,
                        ParameterDirection.Input) { Value = LanguageInd });
                    strResult = Functions.DbFetch(this.ConnectionString, "CUSTOM1", "JGSVALIDATIONS", "GETRESULTBYDEFECT", myParams);
                    if (!strResult.ToUpper().Equals("SUCCESS") || (strResult.ToUpper().Equals("SUCCESS") && !result.ToUpper().Equals("NPF")))
                    {
                        if (strResult.ToUpper().Contains("REPAIRED") ||
                            (result.ToUpper().Equals("REPAIRED") && strResult.ToUpper().Contains("SUCCESS")))
                        {
                            if (!result.ToUpper().Equals("COM_RPR") && Com_Rpr.Contains("YES"))
                            {
                                if (LanguageInd == 0)
                                {
                            ...
                            else if (result.ToUpper().Equals("COM_RPR") && Com_Rpr.Contains("NO"))
                            {
                                if (LanguageInd == 0)
                                {
                            ...
                            else if (!result.ToUpper().Equals("REPAIRED") && Com_Rpr.Contains("NO"))
                            {
                                if (LanguageInd == 0)
                                {
                                    return SetXmlError(returnXml, "You must select REPAIRED Result Code");
                            ...
                            else if (result.ToUpper().Equals("REPAIRED") && Com_Rpr.Contains("YES"))
                            {
                                if (LanguageInd == 0)
                                {
                                    return SetXmlError(returnXml, "You must select COM_RPR Result Code");
                        ...
                        else if (strResult.ToUpper().Contains("NPF"))
                        {
                            if (LanguageInd == 0)
                            {
                                return SetXmlError(returnXml, "You must select NPF Result Code");
                            }
                            else
                            {
                                return SetXmlError(returnXml, "Debe seleccionar el Result Code NPF");
                            }
                        }
                    }
                }                             
                ...
                if (!result.ToUpper().Equals("NPF") && !result.ToUpper().Equals("REPAIRED") && !result.ToUpper().Equals("SCRAP") 
                    && !result.ToUpper().Equals("TO_OBA") && !result.ToUpper().Equals("COM_RPR") && !result.ToUpper().Equals("PACK_VAL"))
                {
                ...
                {
                    if (result.ToUpper().Trim().Equals("NPF") || result.ToUpper().Trim().Equals("REPAIRED") || result.ToUpper().Trim().Equals("COM_RPR") 
                        || result.ToUpper().Trim().Equals("TO_OBA") || result.ToUpper().Trim().Equals("PACK_VAL"))
                    {
                        string FFH25PSU;
                ...
                if ((opt.Equals("INSP") || opt.Equals("WRP1")) && (result.ToUpper().Trim().Equals("NPF") 
                    || result.ToUpper().Trim().Equals("REPAIRED") || result.ToUpper().Trim().Equals("TO_OBA")))
                {
                    ...
                    if (Convert.ToInt32(strResult) > 0)
                    {
                        if (!result.ToUpper().Trim().Equals("REPAIRED") && !result.ToUpper().Trim().Equals("TO_OBA"))
                        {
                            if (OBARequired.ToUpper().Contains("True".ToUpper()))
                            {
                                strResult = "TO_OBA";
                    ...
                    {
                        if (!result.ToUpper().Trim().Equals("NPF") && !result.ToUpper().Trim().Equals("TO_OBA"))
                        {
                            if (OBARequired.ToUpper().Contains("True".ToUpper()))
                            {
                                strResult = "TO_OBA";
                ...
                else
                {
                    ...
                    {
                        if (result.ToUpper().Equals("NPF") || result.ToUpper().Equals("REPAIRED") || result.ToUpper().Equals("TO_OBA")
                            || result.ToUpper().Equals("COM_RPR") || result.ToUpper().Equals("PACK_VAL"))
                        {
                            if (LanguageInd == 0)
                            {
                    ...
                    else
                    {
                            ...
                            && !result.ToUpper().Equals("COM_RPR") && !result.ToUpper().Equals("PACK_VAL"))
                        {
                            if (LanguageInd == 0)
                            {
                                return SetXmlError(returnXml, "CAM ID shoul be 0 for this ResultCode");
                            }
                            else
                            {
                                return SetXmlError(returnXml, "CamId debe cambiar a 0 para este ResultCode");
                            }
                        }
                        ...
                        if (result.ToUpper().Equals("NPF") || result.ToUpper().Equals("REPAIRED") || result.ToUpper().Equals("COM_RPR")
                            || result.ToUpper().Equals("TO_OBA") || result.ToUpper().Equals("PACK_VAL"))
                        {
            ...
            #region "OBA WC validation"
            if (workcenter.ToUpper().Equals("OBA".ToUpper()))
            {
                #region "ValidateResultByDefect WRP"
                if (opt.ToUpper().Equals("WRP") && (result.ToUpper().Equals("NPF") || result.ToUpper().Equals("REPAIRED")
                    || result.ToUpper().Equals("COM_RPR")))
                ...
                #region "INSP HDDSwapValidation"
                if ((opt.Equals("INSP") || opt.Equals("WRP1")) && (result.ToUpper().Trim().Equals("NPF") || result.ToUpper().Trim().Equals("REPAIRED")))
                {
                    Functions.DebugOut("-----  getHDDSwapResult --------> ");
                    myParams = new List<OracleParameter>();
                    myParams.Add(new OracleParameter("itemId", OracleDbType.Int32, itemId.ToString().Length, ParameterDirection.Input) { Value = itemId });
                    ...
                    if (Convert.ToInt32(strResult) > 0)
                    {
                        if (!result.ToUpper().Trim().Equals("REPAIRED"))
                        {   
                            strResult = "REPAIRED";                            
                        }
                        else
                    ...
                    {
                        if (!result.ToUpper().Trim().Equals("NPF"))
                        {   
                            strResult = "NPF";
                        }
                        else
            ...
            #region "PackOut_Val WC validation"
            if (workcenter.ToUpper().Equals("PackOut_Val".ToUpper()))
            {
                #region "SetOBARequiredByRandomIntOBAPercent"
                /* SetOBARequiredByRandomIntOBAPercent.- 
                 * At Timeout work center Pack Out, 1. get PGA flex field OBA_Percent value and compare with Random generated integer
