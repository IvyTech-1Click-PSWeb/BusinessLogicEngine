...
{
    public class DTVLOOPERHDDVALIDATION : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public DTVLOOPERHDDVALIDATION()
        {
            this.Name = "DTVLOOPERHDDVALIDATION";
        }
        ...
        public override XmlDocument Execute(System.Xml.XmlDocument xmlIn)
        {
            ...
            string Schema_name = "WEBAPP1"; //"WEBAPP1";
            string Package_name = "DTVLOOPERHD";
            ...
            if ((Component == "HDD" || Component == "CH06800" || Component == "10215" || Component == "0070" || Component == "AY1") && actioncode == "A012")
            {
                ...
                LooperValue = Functions.DbFetch(this.ConnectionString, Schema_name, Package_name, "GetLooper", myParams);
                ...
                if (!string.IsNullOrEmpty(LooperValue))
                {
                    ...
                    {
                        //return SetXmlError(returnXml, "This Unit already had an HDD replaced, please contact your supervisor to get approval for this replacement/ Esta Unidad actualmente se le cambio un HDD, favor verificar con supervisor para autorizacion del cambio");                
                        //returnXml = AddRoleNameNode(returnXml, "RolName", "YES");
        ...
        {
            //XmlElement RolEle = XmlIn.CreateElement("RolName");
           
            //XmlNodeList Nodo = XmlIn.SelectNodes("/Trigger/Header/UserObj/RolName");
            //XmlElement RolEle;
            ...
            //RolEle.AppendChild(XmlIn.CreateNode(XmlNodeType.Element, "ERE", null));
            ...
            //RolEle.ChildNodes[0].InnerText = NodeName;
           // ffEle.ChildNodes[1].InnerText = NodeValue;
           // XmlIn.DocumentElement["Header"]["UserObj"].AppendChild(Nodo );
            ...
            oldCd.InnerXml = "<RoleName>" + "ERE" + "</RoleName>";
