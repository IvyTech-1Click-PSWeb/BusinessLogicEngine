...
namespace JGS.Web.MSTriggerProvider.MSW {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MicrosoftWrapperSoap", Namespace="http://tempuri.org/")]
    public partial class MicrosoftWrapper : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public MicrosoftWrapper() {
            this.Url = global::JGS.Web.MSTriggerProvider.Properties.Settings.Default.JGS_Web_MSTriggerProvider_MSW_MicrosoftWrapper;
        ...
        public System.Xml.XmlNode GetProductInfo(string SerialNumber) {
        ...
        /// <remarks/>
        public void GetProductInfoAsync(string SerialNumber) {
            this.GetProductInfoAsync(SerialNumber, null);
        }
        
        /// <remarks/>
        public void GetProductInfoAsync(string SerialNumber, object userState) {
            ...
            this.InvokeAsync("GetProductInfo", new object[] {
                        SerialNumber}, this.GetProductInfoOperationCompleted, userState);
        }
