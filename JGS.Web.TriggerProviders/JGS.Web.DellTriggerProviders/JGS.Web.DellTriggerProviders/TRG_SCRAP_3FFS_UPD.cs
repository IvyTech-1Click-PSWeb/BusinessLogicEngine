...
{
    public class TRG_SCRAP_3FFS_UPD : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public TRG_SCRAP_3FFS_UPD()
        {
            this.Name = "TRG_SCRAP_3FFS_UPD";
        }
        ...
        public override XmlDocument Execute(XmlDocument xmlIn)
        {
            ...
            Functions.DebugOut("-----  Inside of Del.#5 - 3 Flex Fields(OEM Warranty, Warr. Term, Dell PN) Upgrade Only --------> ");
            ...
            Functions.DebugOut("<-----  Exited Del.#5 -  - 3 Flex Fields(OEM Warranty, Warr. Term, Dell PN) Only-------- ");
