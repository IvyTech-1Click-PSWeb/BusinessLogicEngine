...
{
    public class TRG_SCRAP_OEMWARR_UPD_XML : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public TRG_SCRAP_OEMWARR_UPD_XML()
        {
            this.Name = "TRG_SCRAP_OEMWARR_UPD_XML";
        }
            ...
            if (WarrStatusFF == "IW")
            {
                ...
                if (PriorityWarrInd == "OW")
                {
                   ...
                   // }
                    ...
                    {
                        Functions.UpdateXml(ref returnXml, xPathDictionary._xPaths["XML_WC_FF_VALUE"].Replace("{FLEXFIELDNAME}", "OEM Warranty"), "IW-OW");
                    }
                    else
                    {
