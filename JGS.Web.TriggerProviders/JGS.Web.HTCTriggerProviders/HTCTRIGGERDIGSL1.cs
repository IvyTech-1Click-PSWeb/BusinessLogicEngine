...
{
    public class HTCTRIGGERDIGSL1 : JGS.Web.TriggerProviders.TriggerProviderBase
    {
        ...
        public HTCTRIGGERDIGSL1()
        {
            this.Name = "HTCTRIGGERDIGSL1";
        }
        ...
        public override XmlDocument Execute(System.Xml.XmlDocument xmlIn)
        {
            ...
            if (Trigger.ToUpper() == "FAILUREANALYSIS")
            {
                ...
                myParams.Add(new OracleParameter("ActionCodeName", OracleDbType.Varchar2, ActionCodeName.Length, ParameterDirection.Input) { Value = ActionCodeName });
                myParams.Add(new OracleParameter("UserName", OracleDbType.Varchar2, UserName.Length, ParameterDirection.Input) { Value = UserName });
                Msg = Functions.DbFetch(this.ConnectionString, "WEBAPP1", "JGSHTCDIGSL1", "GETDEFACT", myParams);
                if (Msg != "OK")
                {
